...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">Mata Kuliah <a href="add_matakuliah.jsp"
...
id="kode" placeholder="Kode Mata Kuliah">
</div>
<div class="col-sm-6">
<input type="number" class="form-control form-control-user"
id="sks" placeholder="SKS">
</div>
</div>
<div class="form-group">
...
<table id="tb_matakuliah" class="table table-bordered" width="100%"
cellspacing="0">
...
var uid = document.getElementById('uid').value;
firebase.database().ref().child('/matakuliah/' + uid).remove();
